...
const allSkills = [
  "React.js", "TypeScript", "Next.js", "React Native", "JavaScript",
  "Redux", "Zustand", "Tailwind", "Node.js", "Git",
  "Figma", "SASS", "Angular", "MUI", "Bootstrap",
  "Firebase", "MongoDB", "REST API", "Axios", "HTML5",
  "CSS3", "RTK Query", "Framer Motion", "ShadCN", "Ant Design",
];
...
const SkillsSphere = ({ className = "" }) => {
  return (
    <div className={`skills_sphere ${className}`}>
      <Canvas
